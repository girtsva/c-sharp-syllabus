...
namespace Hierarchy.Tests
{
    public class ZebraTests
    {
        ...
        public void Setup()
        {
            _target = new Zebra("Stripes", "Zebra", 75.55, "Safari");
        }
        ...
        {
            // Assert
            Assert.AreEqual("Zebra[Stripes, 75.55, Safari, 0]", _target.ToString());
        }
        ...
        public void Eat_Vegetable3_ShouldContainFoodEaten3()
        {
            ...
            // Assert
            Assert.AreEqual("Zebra[Stripes, 75.55, Safari, 3]", _target.ToString());
        }
    }
}